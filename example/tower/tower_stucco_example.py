...
from cqfantasy.tower import TowerBase,TowerMid, TowerTop, RoundBlockAltGenerator, RoundBlockUnevenGenerator, TileGenerator,RoundBlockUnevenStuccoGenerator
...
bp_tower_base.bp_block_gen_outside = RoundBlockUnevenStuccoGenerator()
...
bp_tower_base.bp_block_gen_inside = RoundBlockUnevenStuccoGenerator()
...
bp_tower_mid.bp_block_gen_outside = RoundBlockUnevenStuccoGenerator()
bp_tower_mid.bp_block_gen_outside.uneven_block_depth = 1
bp_tower_mid.bp_block_gen_outside.seed = 'test5'
...
bp_tower_mid.bp_block_gen_inside = RoundBlockUnevenStuccoGenerator()
bp_tower_mid.bp_block_gen_inside.uneven_block_depth = 1
bp_tower_mid.bp_block_gen_inside.seed = 'test5'
...
bp_tower_top.bp_block_gen_outside = RoundBlockUnevenStuccoGenerator()
bp_tower_top.bp_block_gen_outside.uneven_block_depth = 1
bp_tower_top.bp_block_gen_outside.seed = 'test6'
...
bp_tower_top.bp_block_gen_inside = RoundBlockUnevenStuccoGenerator()
bp_tower_top.bp_block_gen_inside.uneven_block_depth = 1
bp_tower_top.bp_block_gen_inside.seed = 'test6'
...
cq.exporters.export(ex,'stl/tower_stucco_example.stl')

base = bp_tower_base.build()
cq.exporters.export(base,'stl/tower_alt_greebled_base.stl')

mid = bp_tower_mid.build()
cq.exporters.export(mid,'stl/tower_stucco_mid.stl')

top = bp_tower_top.build()
cq.exporters.export(top,'stl/tower_stucco_top.stl')